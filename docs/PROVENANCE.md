...
| GPU feasibility pump (#509, off by default): PDHG on the device as the LP projection step; outer loop rounds to integer and repeats until feasible | Fischetti & Lodi, *Feasibility pump*, Mathematical Programming 104 (2005); Mexi et al., *Combining Dual Simplex and GPU PDLP*, arXiv:2307.03466; Corduk et al., *GPU Heuristics for MILP*, arXiv:2510.20499 | `src/gpu/gpu_heuristics.cu` |
