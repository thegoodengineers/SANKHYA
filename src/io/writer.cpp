...
bool write_stats_json(const std::string& path, const Model& model, const Solution& solution,
  ...
  blob["effort"] = {
      ...
      {"cut_rows_aged_out", solution.cut_rows_aged_out},
      {"cuts_reactivated", solution.cuts_reactivated},
      {"cut_filter", solution.cut_filter_report},
      {"kkt_1e4_seconds", json_number(solution.kkt_1e4_seconds)},
      {"kkt_1e6_seconds", json_number(solution.kkt_1e6_seconds)},
      {"kkt_1e8_seconds", json_number(solution.kkt_1e8_seconds)},
      {"kkt_1e4_iterations", solution.kkt_1e4_iterations},
      {"kkt_1e6_iterations", solution.kkt_1e6_iterations},
      {"kkt_1e8_iterations", solution.kkt_1e8_iterations},
    ...
    blob["presolve"] = {
        ...
        {"reductions",
         {{"empty_rows", report.empty_rows},
          ...
          {"probing_probed", report.probing_probed},
          {"probing_fixings", report.probing_fixings},
          {"probing_tightenings", report.probing_tightenings},
          {"probing_implications", report.probing_implications},
          {"probing_conflicts", report.probing_conflicts},
          {"probing_cliques", report.probing_cliques},
