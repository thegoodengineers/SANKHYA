...
src/pdhg          restarted PDHG, CPU; its answer is finished by the interior point (#229)
                                                       (CUDA backend: src/gpu, on main, measured on one card: 1.37x at 10,000 rows, #390/#424)
